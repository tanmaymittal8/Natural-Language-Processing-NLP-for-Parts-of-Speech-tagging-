...
Limitation: Completely ignores sentence context.2. 

Viterbi 1: Standard HMMLogic: 
Implements the standard Viterbi algorithm using:
...
Limitation: Treats all unknown words identically, assigning them a uniform low probability.3. 

Viterbi 2: Hapax Legomena Smoothing
